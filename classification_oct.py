...
def train_model(model, criterion, optimizer, scheduler, num_epochs=400):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 30 == 0:
            torch.save(best_model_wts, os.path.join('./' + str(epoch)+'res18_oct.pth'))
            print('save!')
...
torch.save(classificationNetwork.state_dict(), os.path.join(r'./' + 'res18_oct.pth'))
