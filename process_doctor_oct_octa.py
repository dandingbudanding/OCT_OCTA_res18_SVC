...
data = pd.read_csv("OCT_OCTA.csv")           	#读取csv文件
...
num_list_model = [0.882351,0.909083]
num_list_doctor = [0.97142857,1.]
...
plt.savefig('./savedimg/OCT_OCTA/CNN_Doctor_precission_comparision_AVG.png', dpi=300)
plt.show()
...
name_list = ["inactive CNV", "active CNV"]
num_list_model = [0.882351,0.909083]
num_list_doctor1 = [0.97142857,1.]
num_list_doctor2 = [0.97142857,1.]
num_list_doctor3 = [0.97142857,1.]
x = list(range(len(num_list_model)))
total_width, n = 0.4, 2
width = total_width / n
...
plt.savefig('./savedimg/OCT_OCTA/CNN_Doctor_precission_comparision_EACH.png', dpi=300)
plt.show()
...
print(confu_matrix)
metrics(confu_matrix, save_path="./savedimg/OCT_OCTA/doctor1")

confu_matrix=cal_confu_matrix(np.array(data['B']),np.array(data['D']),class_num=4)
print(confu_matrix)
metrics(confu_matrix, save_path="./savedimg/OCT_OCTA/doctor2")

confu_matrix=cal_confu_matrix(np.array(data['C']),np.array(data['D']),class_num=4)
print(confu_matrix)
metrics(confu_matrix, save_path="./savedimg/OCT_OCTA/doctor3")

name_list = ["inactive CNV", "active CNV"]
num_list_model = [0.967739,0.714283]
num_list_doctor1 = [0.97143, 1.0]
num_list_doctor2 = [0.97143, 1.0]
num_list_doctor3 = [0.97143, 1.0]
...
plt.legend(loc="upper left",bbox_to_anchor=(0.0, 1.1),ncol=4)
plt.savefig('./savedimg/OCT_OCTA/CNN_Doctor_recall_comparision_EACH.png', dpi=300)
plt.show()
...
plt.legend(loc="upper left",bbox_to_anchor=(0.0, 1.1),ncol=2)
plt.savefig('./savedimg/OCT_OCTA/CNN_Doctor_recall_comparision_AVG.png', dpi=300)
plt.show()
